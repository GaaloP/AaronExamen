...
| CP-06 | Validar el caso de Supervisor intentando acceder a una vista o recurso exclusivo de Agente. | Error guessing + partición de equivalencia | Protección de rutas | Funcional manual (Frontend) + integración backend | Alto | Se cierra cuando supervisor no puede acceder a vistas exclusivas de Agente y recibe bloqueo, redirección o 403. | No | aprobado |El supervisor puede acceder de manera correcta tickets de agentes, sin embargo agentes solo pueden visualizar sus tickets propios.| N/A |
